...
public class Constants implements BaseConstants, StorageConstants, ModelConstants {
    ...
    public final static String DEFAULT_SCREENSECONDS = "10";
    public static final String DEFAULT_SCREEN_WIDTH = "1024";
    public static final String DEFAULT_SCREEN_HEIGHT = "768";
